...
export const pagination = {
  getPaginationOptions: (req: Request): { page: number; pageSize: number; offset: number } => {
    const page = req.query.page !== undefined ? parseInt(req.query.page as string, 10) : defaultPage;
    const pageSize = req.query.pageSize !== undefined ? parseInt(req.query.pageSize as string, 10) : defaultPageSize;
